        ...
        with st.expander('Portfolio', expanded=True):
            ...
            if 'slider' in st.session_state:
                ...
                with col_a:
                    ...
                    st.write(((st.session_state.alloc_amount[st.session_state.alloc_amount.index.is_month_end==True]/st.session_state.alloc_amount[st.session_state.alloc_amount.index.is_month_frist==True])))
