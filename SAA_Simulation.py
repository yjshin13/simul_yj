...
if file is not None:
    ...
    #                    names=None, dtype={'Date': datetime}, iimport streamlit as st
import pandas as pd
import resampled_mvo
from datetime import datetime
import matplotlib.pyplot as plt
        ...
        with st.session_state.result_expander1:
            ...
            if 'Target' in st.session_state:
                ...
                with col_a:
                    ...
                    fig_pie2 = px.sunburst(st.session_state.attribution, path=st.session_state.attribution.index, values=st.session_state.attribution)
